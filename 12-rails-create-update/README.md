...
forms form_tag vs form_for 

## SWBATs
- Use Rails generators to create models/migrations/controllers
...
- [] Work on CRUD, focus on routes and ActionView helpers
  - [] Read
    ...
    - [X] Review `link_to` (created a) and path helpers
  - [] Create
